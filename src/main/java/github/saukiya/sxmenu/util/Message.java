...
public enum Message {
    ...
    public static void loadMessage() {
        File file = new File(SXMenu.getInst().getDataFolder(), "Message.yml");
        if (!file.exists()) {
            SXMenu.getInst().getLogger().info("Create Message.yml");
            SXMenu.getInst().saveResource("Message.yml", true);
        }
